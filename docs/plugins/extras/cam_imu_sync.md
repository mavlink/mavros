...
## Publishers
- `~/cam_imu_stamp` ([mavros_msgs::msg::CamIMUStamp](https://docs.ros.org/en/rolling/p/mavros_msgs/msg/CamIMUStamp.html)) - Publish camera IMU trigger timestamp from MAVLink CAMERA_TRIGGER.
