...
- `MOUNT_ORIENTATION` [handler: handle_mount_orientation, dialect: common, msg_id: 265, id: `mavlink::common::msg::MOUNT_ORIENTATION::MSG_ID`]
- `MOUNT_STATUS` [handler: handle_mount_status, dialect: ardupilotmega, msg_id: 158, id: `mavlink::ardupilotmega::msg::MOUNT_STATUS::MSG_ID`]
