...
- `ACTUATOR_CONTROL_TARGET` [handler: handle_actuator_control_target, dialect: common, msg_id: 140, id: `mavlink::common::msg::ACTUATOR_CONTROL_TARGET::MSG_ID`]


## MAVLink Publications
- `SET_ACTUATOR_CONTROL_TARGET` [arg: `act`, dialect: common, msg_id: 139, id: `mavlink::common::msg::SET_ACTUATOR_CONTROL_TARGET::MSG_ID`]
