...
- [`HEARTBEAT`](https://mavlink.io/en/messages/minimal.html#HEARTBEAT) [handler: handle_heartbeat, dialect: minimal, msg_id: 0, id: `mavlink::minimal::msg::HEARTBEAT::MSG_ID`] - automatic message deduction by second argument
...
- [`STATUSTEXT`](https://mavlink.io/en/messages/common.html#STATUSTEXT) [handler: handle_statustext_raw, dialect: common, msg_id: 253, id: `mavlink::common::msg::STATUSTEXT::MSG_ID`] - handle raw message, check framing!
