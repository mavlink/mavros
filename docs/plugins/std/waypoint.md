...
- `MISSION_CURRENT` [handler: handle_mission_current, dialect: common, msg_id: 42, id: `mavlink::common::msg::MISSION_CURRENT::MSG_ID`]
- `MISSION_ITEM_REACHED` [handler: handle_mission_item_reached, dialect: common, msg_id: 46, id: `mavlink::common::msg::MISSION_ITEM_REACHED::MSG_ID`]
