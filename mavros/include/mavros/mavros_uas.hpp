...
public:
  ...
  {
    if (egm96_5) {
      return static_cast<int>(GeographicLib::Geoid::GEOIDTOELLIPSOID) * (*egm96_5)(lla->latitude, lla->longitude);
    } else {
      return 0.0;
    }
  }
  ...
  {
    if (egm96_5) {
      return static_cast<int>(GeographicLib::Geoid::ELLIPSOIDTOGEOID) * (*egm96_5)(lla->latitude, lla->longitude);
    } else {
      return 0.0;
    }
  }
