...
class SystemPlugin(PluginModule):
    ...
    def subscribe_extended_state(
            ...
            callback: SubscriptionCallable,
            qos_profile=STATE_QOS) -> rclpy.node.Subscription:
        return self.create_subscription(ExtendedState, 'extended_state',
    ...
    def subscribe_estimator_status(
            ...
            callback: SubscriptionCallable,
            qos_profile=STATE_QOS) -> rclpy.node.Subscription:
        return self.create_subscription(EstimatorStatus, 'estimator_status',
                                        callback, qos_profile)
    ...
    def subscribe_battery_state(
        ...
        return self.create_subscription(BatteryState, 'battery', callback,
                                        qos_profile)
    ...
    def subscribe_statustest(
            ...
            callback: SubscriptionCallable,
            qos_profile=SENSOR_QOS) -> rclpy.node.Subscription:
        return self.create_subscription(StatusText, ('statustext', 'recv'),
                                        callback, qos_profile)
