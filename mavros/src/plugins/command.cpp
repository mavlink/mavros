...
public:
    ...
    command_ack_timeout_dt(ACK_TIMEOUT_DEFAULT)
  {
    ...
    arming_srv =
      ...
      "~/arming",
      std::bind(&CommandPlugin::arming_cb, this, _1, _2, _3));
    set_home_srv =
      node->create_service<mavros_msgs::srv::CommandHome>(
      "~/set_home",
      std::bind(&CommandPlugin::set_home_cb, this, _1, _2, _3));
    takeoff_srv =
      node->create_service<mavros_msgs::srv::CommandTOL>(
      "~/takeoff",
      std::bind(&CommandPlugin::takeoff_cb, this, _1, _2, _3));
    land_srv =
      node->create_service<mavros_msgs::srv::CommandTOL>(
      "~/land",
      std::bind(&CommandPlugin::land_cb, this, _1, _2, _3));
    trigger_control_srv = node->create_service<mavros_msgs::srv::CommandTriggerControl>(
      "~/trigger_control", std::bind(&CommandPlugin::trigger_control_cb, this, _1, _2, _3));
    trigger_interval_srv = node->create_service<mavros_msgs::srv::CommandTriggerInterval>(
      "~/trigger_interval", std::bind(&CommandPlugin::trigger_interval_cb, this, _1, _2, _3));
    vtol_transition_srv = node->create_service<mavros_msgs::srv::CommandVtolTransition>(
      "~/vtol_transition", std::bind(&CommandPlugin::vtol_transition_cb, this, _1, _2, _3));
  }
