...
public:
  ...
  void initialize(UAS & uas_) override
  {
    ...
    gp_set_global_origin_sub = gp_nh.subscribe(
      "set_gp_origin", 10,
      &GlobalPositionPlugin::set_gp_origin_cb, this);
...
private:
    ...
    mavlink::common::msg::GPS_GLOBAL_ORIGIN & glob_orig)
  {
    ...
    g_origin->position.altitude = glob_orig.altitude / 1E3 + m_uas->geoid_to_ellipsoid_height(
    ...
    mavlink::common::msg::GLOBAL_POSITION_INT & gpos)
  {
    ...
    tf::pointEigenToMsg(
      ftf::transform_frame_ecef_enu(
        local_ecef,
        map_origin), odom->pose.pose.position);
