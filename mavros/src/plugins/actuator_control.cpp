...
public:
  ...
  void initialize(UAS & uas_) override
  {
    ...
    target_actuator_control_pub = nh.advertise<mavros_msgs::ActuatorControl>(
      "target_actuator_control", 10);
    actuator_control_sub = nh.subscribe(
      "actuator_control", 10,
      &ActuatorControlPlugin::actuator_control_cb, this);
  }
...
private:
    ...
    mavlink::common::msg::ACTUATOR_CONTROL_TARGET & actuator_control_target)
  {
    ...
    actuator_control_target_msg->header.stamp = m_uas->synchronise_stamp(
